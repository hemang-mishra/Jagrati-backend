...
import org.jagrati.jagratibackend.dto.ImageKitResponse
...
data class FaceData(
    ...
    @Column(name = "face_response", columnDefinition = "TEXT")
    val faceResponse: String? = null,

    @Column(name = "frame_response", columnDefinition = "TEXT")
    val frameResponse: String? = null,

    @Column(name = "image_response", columnDefinition = "TEXT")
    ...
    val faceWidth: Int? = null, @Column(name = "face_link_id", length = 255)
    val faceLinkId: String? = null,

    @Column(name = "image_link_id", length = 255)
    val imageLinkId: String? = null,

    @Column(name = "frame_link_type", length = 255)
    val frameLinkId: String? = null,
